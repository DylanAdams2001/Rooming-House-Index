...
export default async function PartnersPackagesPage() {
  ...
  return (
    <div>
      <Hint hintKey="partners-packages" title="Packages">
        <p>Add a few named, priced packages — they show on your public profile so investors can compare before ever messaging.</p>
        <p>Attach a PDF brochure to any package if you have one.</p>
      </Hint>
