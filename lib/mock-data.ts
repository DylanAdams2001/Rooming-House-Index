...
const curatedSuburbs: Suburb[] = [
  ...
  },
  {
    ...
    lng: 144.7685623,
    commentary:
      "Albanvale shares postcode 3021 with St Albans but is a distinct suburb — split out here (reverse-geocoded from the Consumer Affairs Victoria register's postcode-level address list) rather than folded into St Albans' figures.",
    rentalTrend: rentalTrend(305),
    supplyGrowth: supplyGrowth(3),
  },
  {
    id: "kealba-3021",
    name: "Kealba",
    ...
    lng: 144.8282988,
    commentary:
      "Kealba shares postcode 3021 with St Albans but is a distinct suburb — split out here (reverse-geocoded from the Consumer Affairs Victoria register's postcode-level address list) rather than folded into St Albans' figures.",
    rentalTrend: rentalTrend(360),
    supplyGrowth: supplyGrowth(1),
  },
  {
    id: "springvale-3171",
    name: "Springvale",
  ...
  },
  {
    ...
    lng: 144.8110919,
    commentary:
      "Sunshine West shares postcode 3020 with Sunshine and Albion but is a distinct suburb — split out here (reverse-geocoded from the Consumer Affairs Victoria register's postcode-level address list) rather than folded into Sunshine's figures.",
    rentalTrend: rentalTrend(355),
    supplyGrowth: supplyGrowth(7),
  },
  {
    id: "albion-3020",
    name: "Albion",
    ...
    lng: 144.8243926,
    commentary:
      "Albion shares postcode 3020 with Sunshine and Sunshine West but is a distinct suburb — split out here (reverse-geocoded from the Consumer Affairs Victoria register's postcode-level address list) rather than folded into Sunshine's figures.",
    rentalTrend: rentalTrend(345),
    supplyGrowth: supplyGrowth(1),
  },
  {
  ...
  },
  {
    ...
    lng: 144.5914403,
    commentary:
      "Kurunjang shares postcode 3337 with Melton and Melton West but is a distinct suburb — split out here since it now has real verified rent data of its own. No addresses from this suburb have turned up in the CAV register scrape yet.",
    rentalTrend: rentalTrend(335),
    supplyGrowth: supplyGrowth(1),
  },
  {
    id: "melton-west-3337",
    ...
    lng: 144.5528895,
    commentary:
      "Melton West shares postcode 3337 with Melton and Kurunjang but is a distinct suburb — split out here since it now has real verified rent data of its own. No addresses from this suburb have turned up in the CAV register scrape yet.",
    rentalTrend: rentalTrend(375),
    supplyGrowth: supplyGrowth(1),
  },
  {
    id: "marshall-3216",
    ...
    lng: 144.357305,
    commentary:
      "Marshall shares postcode 3216 with Highton, Waurn Ponds and Grovedale but is a distinct suburb — split out here since it now has real verified rent data of its own.",
    rentalTrend: rentalTrend(380),
    supplyGrowth: supplyGrowth(1),
  },
  {
    id: "altona-meadows-3028",
    name: "Altona Meadows",
    postcode: "3028",
    state: "VIC",
    council: "Hobsons Bay City Council",
    ...
    lng: 144.7845482,
    commentary:
      "Altona Meadows shares postcode 3028 with Laverton but is a distinct suburb — split out here (reverse-geocoded from the Consumer Affairs Victoria register's postcode-level address list) rather than folded into Laverton's figures.",
    rentalTrend: rentalTrend(395),
    supplyGrowth: supplyGrowth(3),
  },
  {
    id: "corio-3214",
    ...
    lng: 144.3586481,
    commentary:
      "Corio shares postcode 3214 with Norlane but is a distinct suburb — split out here since it now has real verified rent data of its own. No addresses from this suburb have turned up in the CAV register scrape yet.",
    rentalTrend: rentalTrend(320),
    supplyGrowth: supplyGrowth(2),
  },
  {
    id: "golden-square-3555",
    name: "Golden Square",
    postcode: "3555",
    state: "VIC",
    ...
    lng: 144.2543638,
    commentary:
      "Golden Square is a Bendigo suburb with real verified rent data of its own. No addresses from this suburb have turned up in the CAV register scrape yet.",
    rentalTrend: rentalTrend(425),
    supplyGrowth: supplyGrowth(1),
  },
];
